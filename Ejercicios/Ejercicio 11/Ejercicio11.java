// Enunciado:
// Diseñar un algoritmo para calcular el promedio de una serie de números ingresados por el usuario hasta que se ingrese un número cero.
...
public class Ejercicio11 {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Ingrese números para calcular el promedio (ingrese 0 para finalizar):");

        // Bucle para ingresar números hasta que se ingrese un número cero
        while (true) {
